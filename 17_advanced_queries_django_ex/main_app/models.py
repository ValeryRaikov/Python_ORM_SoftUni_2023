...
class VideoGame(models.Model):
    ...
    release_year = models.PositiveIntegerField(
        validators=[
            ...
            validators.MaxValueValidator(2023, message="The release year must be between 1990 and 2023"),
        ]
    )
    rating = models.DecimalField(
        ...
        validators=[
            ...
            validators.MaxValueValidator(10, message="The rating must be between 0.0 and 10.0"),
        ]
    )
...
class Exercise(models.Model):
    ...
    def get_short_and_easy_exercises(cls) -> QuerySet:
        query = Q(duration_minutes__lt=30) & Q(difficulty_level__lt=5)
