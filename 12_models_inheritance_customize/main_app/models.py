...
class ZooKeeper(Employee):
    class EmployeeSpecializations(models.TextChoices):
        Mammals = 'Mammals'
        Birds = 'Birds'
        Reptiles = 'Reptiles'
        Others = 'Others'
    ...
    specialty = models.CharField(
        max_length=10,
        choices=EmployeeSpecializations.choices,
    )
    ...
    def clean(self):
        ...
        # choices = [choice[0] for choice in self.EmployeeSpecializations.choices]

        if self.specialty not in self.EmployeeSpecializations:
