    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(max_length=100, validators=[main_app.validators.is_name_valid])),
                ...
                ('phone_number', models.CharField(max_length=13, validators=[main_app.validators.is_phone_number_valid])),
