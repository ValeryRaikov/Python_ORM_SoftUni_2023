...
engine = create_engine("postgresql+psycopg2://postgres-user:password@localhost/sql_alchemy_ex_db")
...
# recipe1 = create_recipe('A_name', 'A_ingredients', 'A_instructions')
# recipe2 = create_recipe('B_name', 'B_ingredients', 'B_instructions')
# recipe3 = create_recipe('C_name', 'C_ingredients', 'C_instructions')
